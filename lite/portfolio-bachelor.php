      ...
      <div class="page-wrapper">
        <div class="card-block">
          ...
          <div class="card col-xlg-12 col-lg-12 col-md-12 col-sm-12 card-dark">
            <div class="card-block">
              <h1 class="card-title text-center text-white"><i class="mdi mdi-trophy-award text-warning"></i> ผลงานระดับปริญญาตรี <i class="mdi mdi-trophy-award text-warning"></i> </h1>
            </div>
          </div>
        </div>
